    ...
    <div class="col-md"><a ><h1 class="display-3" style="color:blue;"><img src="logo.jpeg"  style="height:80px;">IITR Database</h1></a></div>
        ...
        <table>
            <tr>
                ...
                <td>
                    <div class="card " style="border:2px solid grey; margin-top: 80px; margin-left:140px; height:390px; width: 600px; border-radius: 4px; ">
                        <div class="card-body">
                            <p><font size="6">Name : <?php echo $_SESSION['first_name']." ".$_SESSION['last_name'];?> </font></p>
                            <p><font size="6">Email : <?php echo $_SESSION['email']; ?></font></p>
                            <p><font size="6">Enrollment number : <?php echo $_SESSION['enroll']; ?></font></p>
                            <p><font size="6">Department : <?php if(isset($_SESSION['branch'])){ echo $_SESSION['branch'];}
                                                                 else {echo "Please update your credentials. "; } ?></font></p>
